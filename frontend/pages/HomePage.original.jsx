    ...
    <div style={{ background: "var(--bg)", color: "var(--t1)" }}>
        ...
        <div style={{ maxWidth: 1160, margin: "0 auto", display: "grid",
          ...
          <div>
            <div style={{
              ...
              <span style={{ fontSize: 10, fontWeight: 700, color: "var(--cyan)",
                letterSpacing: "0.1em", fontFamily: "Inter, Manrope, sans-serif" }}>
            ...
            <h1 style={{
              ...
              fontFamily: "Inter, Manrope, sans-serif", marginBottom: 20, letterSpacing: "-0.02em"
            }}>
              Land Your Dream Job{" "}
          ...
          <div style={{ position: "relative", display: "flex", justifyContent: "center" }}>
            ...
            <div style={{
              ...
              <div style={{ fontSize: 14, fontWeight: 700, fontFamily: "Inter, Manrope, sans-serif" }}>Google · Backend SWE</div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ fontSize: 22, fontWeight: 800, color: "#fff", fontFamily: "Inter, Manrope, sans-serif", lineHeight: 1 }}>94%</div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
                ...
                <div>
                  <div style={{ fontSize: 16, fontWeight: 700, fontFamily: "Inter, Manrope, sans-serif" }}>Alex Sharma</div>
        ...
        <div style={{ maxWidth: 900, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 24 }}>
          {stats.map(s => (
            <div key={s.label} style={{ textAlign: "center" }}>
              <div style={{ fontSize: 32, fontWeight: 800, fontFamily: "Inter, Manrope, sans-serif" }} className="text-gradient">{s.value}</div>
        ...
        <div style={{ maxWidth: 1160, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 56 }}>
            <p style={{ fontSize: 12, fontWeight: 700, letterSpacing: "0.12em", color: "var(--cyan)",
              fontFamily: "Inter, Manrope, sans-serif", marginBottom: 12 }}>FEATURES</p>
            <h2 style={{ fontSize: "clamp(28px, 3vw, 42px)", fontWeight: 800, fontFamily: "Inter, Manrope, sans-serif",
            ...
            {features.map(f => (
              <div key={f.title} style={{
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10 }}>
                  <h3 style={{ fontSize: 15, fontWeight: 700, fontFamily: "Inter, Manrope, sans-serif" }}>{f.title}</h3>
                  <span style={{
      ...
      <section style={{ padding: "64px 24px", background: "var(--bg-card)", borderTop: "1px solid var(--border)", borderBottom: "1px solid var(--border)" }}>
        <div style={{ maxWidth: 1000, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 52 }}>
            <p style={{ fontSize: 12, fontWeight: 700, letterSpacing: "0.12em", color: "var(--cyan)", fontFamily: "Inter, Manrope, sans-serif", marginBottom: 12 }}>HOW IT WORKS</p>
            <h2 style={{ fontSize: "clamp(26px, 3vw, 38px)", fontWeight: 800, fontFamily: "Inter, Manrope, sans-serif" }}>From zero to <span className="text-gradient">interview-ready</span></h2>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 24, position: "relative" }}>
            ...
            {steps.map((s, i) => (
              <div key={s.n} style={{ textAlign: "center", position: "relative", zIndex: 1 }}>
                ...
                <h3 style={{ fontSize: 14, fontWeight: 700, fontFamily: "Inter, Manrope, sans-serif", marginBottom: 8 }}>{s.title}</h3>
      ...
      <section style={{ padding: "80px 24px" }}>
        <div style={{ maxWidth: 1160, margin: "0 auto" }}>
          <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", marginBottom: 40 }}>
            <div>
              <p style={{ fontSize: 12, fontWeight: 700, letterSpacing: "0.12em", color: "var(--cyan)", fontFamily: "Inter, Manrope, sans-serif", marginBottom: 10 }}>TEMPLATES</p>
              <h2 style={{ fontSize: "clamp(26px, 3vw, 38px)", fontWeight: 800, fontFamily: "Inter, Manrope, sans-serif" }}>
              ...
              <div key={item.category} style={{
                ...
                <button onClick={() => navigate(`/templates?category=${encodeURIComponent(item.category)}`)}
                  style={{
                    ...
                    fontFamily: "Inter, Manrope, sans-serif", display: "flex", alignItems: "center", justifyContent: "center", gap: 6
                  }}>
                  {item.label} →
                </button>
              </div>
            ...
            {resumeTemplates.slice(0, 6).map(template => (
              <div key={template.id} style={{
                ...
                <div style={{ padding: 16 }}>
                  <div style={{ fontSize: 14, fontWeight: 700, fontFamily: "Inter, Manrope, sans-serif", marginBottom: 2 }}>{template.name}</div>
      ...
      <section style={{ padding: "64px 24px 80px" }}>
        <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center",
          ...
          <p style={{ fontSize: 12, fontWeight: 700, letterSpacing: "0.12em", color: "var(--cyan)", fontFamily: "Inter, Manrope, sans-serif", marginBottom: 16 }}>START TODAY — FREE</p>
          <h2 style={{ fontSize: "clamp(28px, 4vw, 44px)", fontWeight: 800, fontFamily: "Inter, Manrope, sans-serif", marginBottom: 16, letterSpacing: "-0.02em" }}>
