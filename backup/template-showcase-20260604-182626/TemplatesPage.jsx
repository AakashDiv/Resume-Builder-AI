...
export default function TemplatesPage() {
  ...
  const featuredTemplates = useMemo(() => {
    const preferred = ["modern-professional-5", "ats-friendly-resume-10", "simple-professional", "professional-cv"];
  ...
  return (
    <main className="template26-page">
      <section className="template26-hero">
        <div className="template26-shell template26-market-header">
          <div>
            ...
            <p>
              Professional, ATS-friendly templates you can preview instantly and edit in the builder.
            </p>
          </div>
      ...
      <section className="template26-shell template26-featured-market">
        <div className="template26-results-bar">
          <div>
            <p>Featured templates</p>
            <span>Premium layouts selected for fast resume building</span>
          </div>
        </div>
        <div className="template26-featured-row">
